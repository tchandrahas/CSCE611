...
void test_memory(ContFramePool * _pool, unsigned int _allocs_to_go) {
    ...
    if (_allocs_to_go > 0) {
        ...
        // reallocate of the frame should proceed without any errors
        /*if(frame != _pool->get_frames(n_frames))
        {
          Console::puts("free'ing not done properly");
        }*/
